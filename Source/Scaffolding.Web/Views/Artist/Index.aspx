<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<PagedList<SubSonic.Web.Models.Artist>>" %>
...
<script type="text/javascript">
    ...
    $('#search').autocomplete("/Artist/list/", {
            minChars: 2
        });
...
<form action="<%=Url.Action("index") %>" method="post">
    ...
    <table>
        <tr>
            ...
            <th>
                <a href="<%=Url.CreateSortLink("Index","Name") %>"> Name</a>
            </th>
        </tr>
